...
const text = {
  ...
  'Merchant Settings Update': 'Обновление настроек мерчанта',
...
const fields = {
  ...
  isEnabledApplePay: 'Включена оплата Apple Pay',
  isEnabledGooglePay: 'Включена оплата Google Pay',
  isEnabledPhonePayment: 'Включена оплата балансом моб.тела',
  isEnabledCardCustomerLimit: 'Включен лимит по транзакциям по картам пользователя',
  isAllowedToRetryPayments: 'Включен функционал повторения платежей',
  disableCachingCustomerFailedPayment: 'Выключено кеширование неуспешных гейтов у пользователя',
  shouldRedirectToOurPaymentPage: 'Включен редирект на на нашу страницу статуса после оплаты',
